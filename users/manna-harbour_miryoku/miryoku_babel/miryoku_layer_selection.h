...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_ASTHNEOI)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_ASTHNEOI_FLIP
    #elif defined (MIRYOKU_ALPHAS_THE1)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_THE1_FLIP
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_ALPHAS_ASTHNEOI)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_ASTHNEOI
    #elif defined (MIRYOKU_ALPHAS_THE1)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_THE1
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_ASTHNEOI)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_ASTHNEOI_FLIP
    #elif defined (MIRYOKU_EXTRA_THE1)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_THE1_FLIP
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_EXTRA_ASTHNEOI)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_ASTHNEOI
    #elif defined (MIRYOKU_EXTRA_THE1)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_THE1
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_ASTHNEOI)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_ASTHNEOI_FLIP
    #elif defined (MIRYOKU_TAP_THE1)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_THE1_FLIP
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_TAP_GAMING)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GAMING
    #elif defined (MIRYOKU_TAP_ASTHNEOI)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_ASTHNEOI
    #elif defined (MIRYOKU_TAP_THE1)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_THE1
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH
    #endif
  #endif
