...
#define MIRYOKU_ALTERNATIVES_BASE_ASTHNEOI \
KC_Q,              KC_W,              KC_D,              KC_R,              KC_F,              KC_J,              KC_L,              KC_U,              KC_QUOT,           KC_P,              \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_T),      LSFT_T(KC_H),      KC_G,              KC_Y,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_I),      \
LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_K,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_THE1 \
KC_K,              KC_M,              KC_L,              KC_U,              KC_SLSH,           KC_V,              KC_D,              KC_R,              KC_QUOT,           KC_Q,              \
LGUI_T(KC_A),      LALT_T(KC_T),      LCTL_T(KC_H),      LSFT_T(KC_E),      KC_DOT,            KC_C,              LSFT_T(KC_S),      LCTL_T(KC_N),      LALT_T(KC_O),      LGUI_T(KC_I),      \
LT(U_BUTTON,KC_Z), ALGR_T(KC_P),      KC_F,              KC_J,              KC_COMM,           KC_B,              KC_G,              KC_W,              ALGR_T(KC_X),      LT(U_BUTTON,KC_Y), \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP
...
KC_TAB,            KC_Q,              KC_W,              KC_E,              KC_R,              KC_Y,              KC_7,              KC_8,              KC_9,              KC_T,              \
KC_LSFT,           KC_A,              KC_S,              KC_D,              KC_F,              KC_H,              KC_4,              KC_5,              KC_6,              KC_G,              \
...
KC_GRV,            KC_1,              KC_2,              KC_3,              KC_NUBS,           U_NA,              TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    KC_ALGR,           U_NA,              \
...
S(KC_NUHS),        KC_EXLM,           KC_AT,             KC_NUHS,        S(KC_NUBS),           U_NA,              TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  KC_ALGR,           U_NA,              \
